<template>
    <q-layout>
        <q-page-container>
            <q-page class="q-pa-md" style="background-color: aliceblue;">
                <div
                    ...
                    <div class="header">
                        <div class="title">DANH SÁCH TẦNG CỦA GIÁ</div>
                        <div class="search">
        ...
        <q-dialog v-model="addModal" full-width position="top">
            <q-card>
                <q-card-section>
                    <div class="text-h4" style="color: blue;">THÊM MỚI TẦNG CỦA GIÁ</div>
                </q-card-section>
                <q-card-section>
                    <q-list class="row">
                        ...
                        <q-item class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <q-item-section>
                                <q-select v-model="newRow.FloorOfPrice_form" label="TÊN GIÁ" label-color="blue"
                                    @filter="filter_FloorOfPrice" :options="list_FloorOfPrice" lazy-rules
        ...
        <q-dialog v-model="editModal" full-width position="top">
            <q-card class="row ">
                <q-card-section>
                    <div class="text-h4" style="color:blue ;">CHỈNH SỬA TẦNG CỦA GIÁ</div>
                </q-card-section>
                <q-card-section>
                    ...
                    <q-list class="row">
                        <q-item class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <q-item-section>
                                <q-select v-model="editedRow.FloorOfPrice_form" label="TÊN GIÁ" label-color="blue"
                                    @filter="filter_FloorOfPrice" :options="list_FloorOfPrice" lazy-rules
                                    :rules="['Không được để trống']" use-input use-chips
        ...
        <q-dialog v-model="detailsModal" full-width position="top">
            <q-card class=" ">
                <q-card-section>
                    <div class="text-h4" style="color: blue;">{{ detailsRow.FloorOfPrice_form }}</div>
                </q-card-section>
                <q-card-section>
                </q-card-section>
                ...
                <q-card-section style="font-size: larger;">
                    ...
                    <q-item class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <q-item-section>
                            <div><strong>PHÒNG:</strong> {{ detailsRow.Room_form }}</div>

                        </q-item-section>
                    </q-item>
                    <q-item class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <q-item-section>
                            <div><strong>TÊN KỆ:</strong> {{ detailsRow.Shelf_form }}</div>
                    ...
                    <q-item class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <q-item-section>
                            <div><strong>TÊN GIÁ:</strong> {{ detailsRow.Price_form }}</div>
...
export default {
    data() {
        return {
            ...
            columns: [
                ...
                {
                    name: 'FloorOfPrice_form',
                    label: 'TÊN TẦNG CỦA GIÁ',
                    align: 'center',
                    field: 'FloorOfPrice_form'
                },
                ...
                { name: 'Price_form', label: 'TÊN GIÁ', align: 'center', field: 'Price_form' },
    ...
    computed: {
        filteredRows() {
            ...
            return this.rows.filter(
                (row) =>
                    row.FloorOfPrice_form.toLowerCase().includes(query) ||
                    ...
                    row.Price_form_form.toLowerCase().includes(query) ||
    ...
    methods: {
        openAddModal() {
            this.newRow = {
                id: null, FloorOfPrice_form: '', Shelf_form: '', warehouse_form: '', Floor_form: '', Room_form: '',
                date: '', status: "Mới",
            };
            this.addModal = true;
        },
        addNewRow() {
            if (this.newRow.Shelf_form && this.newRow.warehouse_form && this.newRow.Floor_form && this.newRow.Room_form && this.newRow.Price_form && this.newRow.date && this.newRow.FloorOfPrice_form) {
