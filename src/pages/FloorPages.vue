<template>
    <q-layout>
        ...
        <q-dialog v-model="addModal" full-width position="top">
            <q-card>
                <q-card-section>
                    <div class="text-h4" style="color: blue;">THÊM MỚI PHÒNG</div>
                </q-card-section>
                <q-card-section>
                    <q-list class="row">
                        ...
                        <q-item class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <q-item-section>
                                <q-select v-model="newRow.Room_form" label="TÊN MÃ PHÒNG" label-color="blue"
        ...
        <q-dialog v-model="editModal" full-width position="top">
            <q-card class="row ">
                <q-card-section>
                    <div class="text-h4" style="color: blue;">CHỈNH SỬA PHÒNG</div>
                </q-card-section>
                <q-card-section>
                    <q-list class="row">
        ...
        <q-dialog v-model="detailsModal" full-width position="top">
            <q-card class=" ">
                <q-card-section>
                    <div class="text-h4">{{ detailsRow.Room_form }}</div>
                </q-card-section>
...
export default {
    ...
    methods: {
        openAddModal() {
            this.newRow = {
                id: null, Room_form: '', warehouse_form: '', Floor_form: '',
                date: '', status: "Mới",
            };
            this.addModal = true;
        },
        addNewRow() {
            if (this.newRow.Room_form && this.newRow.warehouse_form && this.newRow.Floor_form && this.newRow.date) {
